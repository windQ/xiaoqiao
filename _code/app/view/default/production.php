	...
	<div class="cont w1000">
		...
		<?php foreach( $sub_column as $ls_sub ):;?>
			<li class="<?php $curr = 'ck_'.$ls_sub->id;echo $$curr;?>">
			    <a href = "<?php echo url('/news',array('column'=>$column,'sub_id'=>$ls_sub->id));?>" title = "<?php echo $ls_sub->name;?>"><?php echo $ls_sub->name;?></a>
			</li>
		<?php endforeach;?>
		</ul>
		<div class="cont_right">
			...
			<ul style="display:block">
			    <?php foreach( $column_for_data as $data ):;?>
				<li>
					<a href="">
						<img src="images/img_010.jpg">
						<p>总监新娘化妆</p>
					</a>
				</li>
				<?php endforeach;?>
