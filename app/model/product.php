...
/**
 * Product 封装来自 product 数据表的记录及领域逻辑
 */
class Product extends QDB_ActiveRecord_Abstract
{
	...
	function get_images()
	{
		...
		{
			$ret_images[ $key ][ 'thumb' ] = $image;
			$ret_images[ $key ][ 'middle' ] = str_replace( '_thumb' , '_middle', $image );
			$ret_images[ $key ][ 'origin' ] = str_replace( '_thumb' , '', $image );
		}
		return $ret_images;
	}
    ...
    static function __define()
    {
        ...
        (
            ...
            (
                ...
                //取出图片组 thumb middle
                'get_images' => array( 'getter' => 'get_images' ),
